...
from keras.layers import Dense, Dropout, LSTM, Input, concatenate, Bidirectional
...
for LSTM_NODES, FNN_NODES, FNN_LAYERS,LSTM_LAYERS in random_hyperparameters:
    ...
    for ilayer in range(LSTM_LAYERS):
        output = Bidirectional(LSTM(LSTM_NODES, activation='tanh', return_sequences=(ilayer<LSTM_LAYERS-1)))(output)
